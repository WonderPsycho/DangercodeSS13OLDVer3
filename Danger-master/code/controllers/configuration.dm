/datum/configuration
	...
	var/vote_autotransfer_initial = 3 HOURS 	// Length of time before the first autotransfer vote is called
	var/vote_autotransfer_interval = 1 HOURS 	// length of time before next sequential autotransfer vote
	var/vote_autotransfer_max_votes = 5			// AFTER this many votes, the NEXT autotransfer will be forced
	var/vote_for_autotransfer = 1
