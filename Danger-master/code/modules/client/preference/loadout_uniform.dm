...
/datum/gear/uniform/skirt/job/ntrep
	...
	allowed_roles = list("A.R.F. Representative")
...
/datum/gear/uniform/casual/redpj
	display_name = "PJ's, Red"
	path = /obj/item/clothing/under/pj/red

/datum/gear/uniform/casual/bluepj
	display_name = "PJ's, Blue"
	path = /obj/item/clothing/under/pj/blue

/datum/gear/uniform/casual/victdress
