...
/datum/belly/proc/digestion_death(var/mob/living/M)
	...
	if(config.items_survive_digestion)
		...
		// woopsie, jon spaghettified the code, someone might need to revisit this soon. TO DO: Fix Brains being removed from MMIs in vore. . _.
		/*
			if(istype(W,/obj/item/organ/internal/brain/mmi_holder/posibrain))
