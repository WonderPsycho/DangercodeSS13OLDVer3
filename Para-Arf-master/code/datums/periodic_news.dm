...
/datum/news_announcement
	var
		...
		author = "Alliance of Racial Federation Editor"
	...
	revolution_inciting_event
		...
		paycuts_suspicion
			round_time = 60*10
			message = {"Reports have leaked that Alliance of Racial Federation Co. is planning to put paycuts into
		...
		human_experiments
			...
			message = {"Unbelievable reports about human experimentation have reached our ears. According
			 			...
			 			the experiments, and reported to have died in a \"work accident\" by Alliance of Racial Federation Editor Co."}
			author = "Unauthorized"
	...
	food_riots
		...
		breaking_news
			...
			message = {"Breaking news: Food riots have broken out throughout the Refuge asteroid colony in the Tenebrae
						Lupus system. This comes only hours after Alliance of Racial Federation officials announced they will no longer trade with the
						colony, citing the increased presence of \"hostile factions\" on the colony has made trade too dangerous to
						continue. Alliance of Racial Federation officials have not given any details about said factions. More on that at the top of
						the hour."}
			round_time = 60 * 10
		...
		more
			...
			message = {"More on the Refuge food riots: The Refuge Council has condemned Alliance of Racial Federation's withdrawal from
			the colony, claiming \"there has been no increase in anti-A.R.F. activity\", and \"\[the only] reason
			Alliance of Racial Federation withdrew was because the \[Tenebrae Lupus] system's Plasma deposits have been completely mined out.
			We have little to trade with them now\". Alliance of Racial Federation officials have denied these allegations, calling them
			\"further proof\" of the colony's anti-A.R.F. stance. Meanwhile, Refuge Security has been unable to quell
