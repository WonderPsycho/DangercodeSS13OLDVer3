...
/obj/item/weapon/book/manual/security_space_law
	name = "Space Law"
	desc = "A set of A.R.F. guidelines for keeping law and order on their space stations."
...
/obj/item/weapon/book/manual/faxes
	...
	desc = "A A.R.F.-approved guide to writing faxes"
	icon_state = "book6"
	author = "A.R.F."
	...
	dat = {"
		...
		<html>
				...
				<li>We at A.R.F. provide Fax Machines to every Head of Staff, in addition to the Magistrate, A.R.F. Representative, and Internal Affairs Agents.</li>
				...
				<li>This means that you should work with the Heads of Staff concerning personnel and workplace issues, and attempt to resolve situations with them. If, for whatever reason, the relevent Head of Staff is not available or receptive, consider speaking with the Captain and/or A.R.F. Representative.</li>
	...
	dat = {"
		...
		<html>
                ...
                <ul>
                    ...
                    <li>CentComm Authorisation is required for hiring the following: Blueshield, Security Pod Pilot, Magistrate, Brig Physician, A.R.F. Representative, Mechanic.</li>
	...
	dat = {"
		...
		<html>
				...
				<ol>
					...
					<li><a href="#ntrep">A.R.F. Representative</a></li>
				...
				<ol>
					...
					<li>The Captain, despite being in charge of the Cyberiad, is not independent from A.R.F. Any attempts to disregard general company policy are to be considered an instant condition for contract termination;</li>
				...
				<ol>
					...
					<li>The Head of Personnel may not promote any personnel to the following Jobs without authorization from Central Command: Barber, Brig Physician, A.R.F. Representative, Blueshield, Security Pod Pilot, Mechanic and Magistrate; (This is due to them being karma locked. Do not promote people to these positions without approval from the Administrators);</li>
				...
				<h1><a name="ntrep"><B>A.R.F. Representative</B></a></h1><BR>
				<ol>
					<li>The A.R.F. Representative is to ensure that every Department is following Standard Operating Procedure, up to and including the respective Head of Staff. If a Head of Staff is not available for a Department, the A.R.F. Representative must ensure that the Captain appoints an Acting Head of Staff for said Department;</li>
					<li>The A.R.F. Representative must attempt to resolve any breach of Standard Operating Procedure locally before contacting Central Command. This is an imperative: Standard Operating Procedure should always be followed unless there is a very good reason not to;</li>
					<li>The A.R.F. Representative must, together with the Magistrate and Head of Security, ensure that Space Law is being followed and correctly applied;</li>
					<li>The A.R.F. Representative may not threaten the use of a fax in order to gain leverage over any personnel, up to and including Command. In addition they may not threaten to fire, or have Central Command, fire anyone, unless they actually possess a demotion note;</li>
					<li>The A.R.F. Representative is permitted to carry their Stun-Cane, or a Telescopic Baton if the Stun-Cane is lost.</li>
				</ol><BR>
				...
				<ol>
                    ...
                    <li>Any use of the "Purge" Module is to be followed by the upload of a A.R.F.-approved Lawset immediately. AI Units must be bound to a Lawset at all times.</li>
				</ol><BR>
				</body>
				</html>
