...
/datum/dna/gene/disability/speech/chav/OnSay(var/mob/M, var/message)
	...
	//Adding stuff after Security.  Not really in any kind of order.  Who needs orders.  Right? ~TK
	...
	message = replacetext(message,"gay","puff")
	message = replacetext(message,"great","clutch")
	message = replacetext(message,"awesome","clutch")
	message = replacetext(message,"cool","clutch")
	message = replacetext(message,"bitch","floozie")
	message = replacetext(message,"alright","aw rate")
	message = replacetext(message,"alright","aight")
	message = replacetext(message,"was","were")
	message = replacetext(message,"here","'ere")
	message = replacetext(message,"bro","bruv")
	message = replacetext(message,"rich","minted")
	message = replacetext(message,"happy","gassed")
	message = replacetext(message,"love","luv")
	message = replacetext(message,"making","makin'")
	message = replacetext(message,"and","n'")
	message = replacetext(message,"even","evun")
	message = replacetext(message,"the","de")
	message = replacetext(message,"isn't it","innit")
	message = replacetext(message,"daughter","dautuh")
	message = replacetext(message,"this","dis'")
	message = replacetext(message,"that","dat'")
	message = replacetext(message,"that's","das'")
	message = replacetext(message,"with","wid")
	message = replacetext(message,"have","'ave")
	message = replacetext(message,"crazy","barmy")
	message = replacetext(message,"fuck","bugger")
	message = replacetext(message,"vagina","fanny")
	message = replacetext(message,"drunk","legless")
	message = replacetext(message,"dick","todger")
	message = replacetext(message,"how","'ow")
	return message
