...
/datum/game_mode/shadowling
	...
	protected_jobs = list("Security Officer", "Warden", "Detective", "Head of Security", "Captain", "Blueshield", "A.R.F. Representative", "Security Pod Pilot", "Magistrate", "Brig Physician", "Internal Affairs Agent", "A.R.F. Navy Officer", "Special Operations Officer")
...
/datum/species/shadow/ling
	...
	species_traits = list(NO_BLOOD, NO_BREATHE, RADIMMUNE, NOGUNS, NOT_CREW, IS_WHITELISTED) //Can't use guns due to muzzle flash
...
/datum/species/shadow/ling/lesser //Empowered thralls. Obvious, but powerful
	...
	species_traits = list(NO_BLOOD, NO_BREATHE, RADIMMUNE, NOT_CREW, IS_WHITELISTED)
	burn_mod = 1.1
	oxy_mod = 0
