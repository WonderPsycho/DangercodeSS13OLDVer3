...
/obj/item/clothing/accessory/holobadge/attack_self(mob/user as mob)
	if(!stored_name)
		...
		return
	if(isliving(user))
		user.visible_message("<span class='warning'>[user] displays their A.R.F. Internal Security Legal Authorization Badge.\nIt reads: [stored_name], A.R.F. Security.</span>","<span class='warning'>You display your A.R.F. Internal Security Legal Authorization Badge.\nIt reads: [stored_name], A.R.F. Security.</span>")
